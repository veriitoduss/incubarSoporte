...
(function (e) {
  ...
  j.Api.register("buttons.info()", function (a, b, c) {
    ...
    if (!1 === a)
      return (
        e("#datatablesTicket_buttons_info").fadeOut(function () {
          e(this).remove();
        }),
        clearTimeout(p),
        (p = null),
    ...
    p && clearTimeout(p);
    e("#datatablesTicket_buttons_info").length &&
      e("#datatablesTicket_buttons_info").remove();
    e('<div id="datatablesTicket_buttons_info" class="dt-button-info"/>')
      .html(a ? "<h2>" + a + "</h2>" : "")
